...
MISSING_TRIP_MESSAGE = "No active trip yet. Start one with /newtrip Demo Trip SGD."
...
NEWTRIP_GUIDE_MESSAGE = "Tell me the trip name and base currency, like /newtrip Demo Trip SGD."
